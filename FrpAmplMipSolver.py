...
class FrpAmplMipSolver(solver.Solver):
    ...
    def solve(self, prob, K=10, C=150): 
        if type(prob) == frp.FastRouteProb:
            # Création du modèle
            ampl_path = os.path.normpath('C:\\Users\\Utilisateur\\Documents\\BAA\\Hiver 2020\\MQT-2100\\ampl_mswin64 (2)')#'C:\Users\maria\Downloads\ampl_mswin64'
            ampl_env = amplpy.Environment(ampl_path)
            ampl = amplpy.AMPL(ampl_env)
            ampl.setOption('solver', 'gurobi')
            ampl.setOption('gurobi_options', 'timelim 2000 outlev 1')
            dir_ampl = os.path.normpath('C:\\Users\\Utilisateur\\Documents\\BAA\\Hiver 2020\\MQT-2100\\Travaux\\TP2\\TSP AMPL')#'C:\Users\maria\Desktop\SIAD\equipe3_TP2\equipe3_TP2'
