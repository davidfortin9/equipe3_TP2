...
def twobyone(warehouse_width,warehouse_length,node_distance,center_aisle_width,bottom_aisle_width,aisle_width,aisle_angle_degree,slots_per_node):
    ...
    if aisle_angle_degree<90 and aisle_angle_degree>0:
        ...
        section_size = [(warehouse_length-center_aisle_width)/2,warehouse_width-bottom_aisle_width]
